<template>
  <main id="layout" :class="largeNotch ? 'notch-large' : ''">
    <div id="notch">
      <!-- class="animate__animated animate__flip animate__infinite animate__slower animate__delay-2s"-->
      ...
      <div class="logo">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 93.927086 59.531242">
          <path
            d="M35.93262 4.6418l11.81816 6.69539L59.56894 4.6418v13.67568l-11.81816 6.83784v13.53323l-11.81816-6.83784V18.17503"
          ></path>
        </svg>
      </div>
    </div>
