<template>
  <div v-if="glitch" class="glitch" :class="'glitch-' + glitch.type">
    <video autoplay="true" loop="true" muted="true" width="100%" height="100%">
      ...
      <source
        v-if="glitch.video === '3'"
        src="@/assets/glitches/nullsectest18_0001-1201-4x-RIFE-RIFE3.1-48fps.webm"
        type="video/webm"
      />
      <source
        v-if="glitch.video === '4'"
        src="@/assets/glitches/nullsectest17000_1-1201-4x-RIFE-RIFE3.1-48fps.webm"
        type="video/webm"
      />
      <source
        v-if="glitch.video === '5'"
        src="@/assets/glitches/nullsecvq8_0001-1201_esrgan-4x-RIFE-RIFE3.1-48fps.webm"
        type="video/webm"
      />
      <source
        v-if="glitch.video === '6'"
        src="@/assets/glitches/nullsectest8_0001-1201-4x-RIFE-RIFE3.1-48fps(1).webm"
        type="video/webm"
      />
      <source
        v-if="glitch.video === '7'"
        src="@/assets/glitches/nullsectest10_0001-1201-4x-RIFE-RIFE3.1-48fps.webm"
        type="video/webm"
      />
      <source
        v-if="glitch.video === '8'"
        src="@/assets/glitches/nullsecvq80001-1201_esrgan.webm"
        type="video/webm"
      />
    </video>
